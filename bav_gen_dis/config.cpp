...
class CfgPatches
{
	class bav_gen_dis
	{
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"A3_weapons_f","A3_weapons_f_exp","ace_common", "Burnes_FV4034","FIR_A10A_F","FIR_A10C_F","FIR_AV8B_F","FIR_F16_F","FIR_F16D_F","FIR_F16_RSSpecial_F","FLAN_EA18G_F","r3f_armes_c","r3f_armes","r3f_acc","bav_gen_comp"};
		versionAr[] = {1,0,0};
		author = "B.A.Verrecus";
	};
};
